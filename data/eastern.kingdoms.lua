...
ns.points[122] = {
    [41003200] = {
        achievement = 868,
        criteria = 0,
        criteriaName = "Dawnstar Village"
    }, -- Dawnstar Village
    [63004800] = {
        achievement = 868,
        criteria = 0,
        criteriaName = "Greengill Coast"
    }, -- Greengill Coast
    [60003000] = {
        achievement = 868,
        criteria = 0,
        criteriaName = "Magisters' Terrace"
    }, -- Magisters' Terrace
    [54003300] = {
        achievement = 868,
        criteria = 0,
        criteriaName = "Sun's Reach Harbor"
    }, -- Sun's Reach Harbor
    [40004500] = {
        achievement = 868,
        criteria = 0,
        criteriaName = "Sunwell Plateau"
    }, -- Sunwell Plateau
    [53008400] = {
        achievement = 868,
        criteria = 0,
        criteriaName = "The Dead Scar"
    } -- The Dead Scar
}
--------------------------------------------------------------------------------------------
